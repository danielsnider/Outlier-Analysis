function [idxEG1,idxLG1,idxG1S,idxS,idxG2] = FindStages_v2(DNA,lGem,varargin)
% Assigns cells to five cell cycle stages.
% DIFFERENCE FROM FIRST VERSION: LINE 35 CHANGED TO ADAPT FOR A RARE
% SITUATION. ADDITIONAL FIX ADDED AT LINE 42. IN MOST CASES, THE FIRST VERSION WILL WORK PERFECTLY. CODE WAS
% RENAMED SO THAT PREVIOUS WORK WOULD NOT BE AFFECTED (BUT THAT IS UNLIKELY
% IN ANY CASE). FUTURE IMPROVEMENTS WILL BE MADE TO THIS VERSION ONLY.
%
% INPUTS
...
idxS = DNA>DNA_thr2&DNA<DNA_thr3&lGem>Gem_thr3;
idxG2 = DNA>DNA_thr3&DNA<DNA_thr4&lGem>Gem_thr2;
% Visualization
